...
// testing
    ...
    alert(user.first_name)
        if (user) {
            ...
            this.setState({ categoryYangDipilih: defaultCategory });
        }
// xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx      
  ...
  getProductsByCategory = (category) => {
    axios
      .get(API_URL + "/menulist/" + category) // .get('/data/db.json')// .get(API_URL + "products?category.nama=" + category)
      .then(res => {
